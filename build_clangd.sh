...
if buildAll || hasArg libmps_parser; then
    ...
    ln -sf "${LIBMPS_PARSER_BUILD_DIR}/compile_commands.json" "${REPODIR}/cpp/libmps_parser/compile_commands.json"
...
if buildAll || hasArg libcuopt || hasArg cuopt_grpc_server; then
    ...
    ln -sf "${LIBCUOPT_BUILD_DIR}/compile_commands.json" "${REPODIR}/cpp/compile_commands.json"
